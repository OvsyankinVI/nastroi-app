      ...
      <main className="landing">
        <section className="hero">
          <div className="heroText">
            ...
            <h1>
              Близкие поймут тебя без лишних слов
            </h1>
        ...
        <section className="section">
          ...
          <p>
            ...
            поддержки или просто,
            чтобы тебя не трогали.
          </p>

          <p>
            Настрой помогает близким
            увидеть твое состояние
            и понять, что тебе сейчас действительно нужно.
          </p>
        </section>

        <section className="steps">
          <Step number="01" title="Создай своего персонажа" text="Сделай аватар, который отражает именно тебя." />
          <Step number="02" title="Поделись своим состоянием" text="Покажи, что ты чувствуешь прямо сейчас." />
          <Step number="03" title="Пригласи близких" text="Через QR-код или ссылку. Буквально за секунду." />
          <Step number="04" title="Будьте ближе" text="Понимай настроение друзей, партнера и семьи." />
        </section>
        ...
        <p>
          Добавь виджет на экран iPhone
          и в Apple Watch —
          чтобы в любой момент понимать,
          как чувствуют себя важные для тебя люди.
        </p>
        ...
        <div className="widgetsGrid">
          <div className="widgetCard">
            ...
            <p>
              Видишь состояние близкого
              прямо на рабочем столе телефона.
            </p>
          </div>
          ...
          <div className="widgetCard">
            ...
            <p>
              Проверяй настрой друзей
              прямо с часов и открывай
              приложение для полного списка.
            </p>
          </div>
        </div>
      </section>
        ...
        <section className="section cycle">
          <div>
            ...
            <p>
              Настрой может учитывать
              повторяющиеся эмоциональные циклы,
              чтобы близкие лучше чувствовали твой ритм
              и выбирали правильный момент
